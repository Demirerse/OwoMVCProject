        ...
        public static string UploadImage(string serverPath, HttpPostedFileBase file)
        {
            if (file != null)
            {
                ...
                if (extension == "jpg" || extension == "gif" || extension == "png" || extension == "jpeg")
                {
                    ...
                    {
                        return "Dosya zaten var"; //( 1 Dosya zaten var kodu) ancak Guid ile isim belirledigimiz bu açıdan mevcut şartlarda güvendeyiz...Eger siz ismi Guid ile degil de anlamlı olabilmesi icin kullanıcı input'undan alırsanı o zaman bu kontrolü yapmalısınız...
                    }
                    else
                    {
                ...
                {
                    return "Seçilen dosya jpg, gif, png, jpeg formatında olmalıdır"; // 2 Secilen dosya bir resim degildir
                }


            }

            return "Dosya boş"; // 3 Dosya null kodu
        }
